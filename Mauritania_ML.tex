...
\newpar Hence, there is a growing demand from the cartographic community as well as environmental decision makers for the use of ML tools as automated and principally new step in mapping and RS domains. Instead of unsupervised classification available in traditional software and clustering methods, GRASS GIS enables to collect the information of land categories with ML-based methods. This is a significant advantage of GRASS GIS since not all the GIS have such ML tools available in the functionality. With this regards, GRASS GIS presents perspectives of using the advanced embedded ML methods which can identify and record land cover classes on the satellite images in an Artificial Intelligence (AI)-based manner using computer vision techniques. 
