...
\newpar The data used in this study include six satellite multispectral images Landsat, with main characteristics summarised in Table \ref{tab1}. Image analysis and classification of the Landsat 8-9 OLI/TIRS satellite images using clustering method was done by k-means and unsupervised method which is included in the maximum-likelihood discriminant analysis classifier by GRASS GIS. The raw images are presented in Figure \ref{fig05} showing scenes for November months for years 2014, 2017, 2018, 2020, 2022 and 2023.
